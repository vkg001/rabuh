            ...
            <form action="<?php echo explode(".", $_SERVER['PHP_SELF'])[0] ?>" id="post-form" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <img id="previewImage" style="max-height: 20rem; max-width: 100%;" onclick="document.getElementById('file').click()" src="https://res.cloudinary.com/dza7mzhl1/image/upload/v1689689532/upload_image_placeholder_grey_yyxr3u.png" alt="Upload Image">
                    </div>
                    <div class="col-sm-8">
        ...
        async function preview() {
            ...
            if (!isImage($("#file").val())) {
                ...
                if (res === false) {
                    ...
                    document.getElementById("previewImage").src = "https://res.cloudinary.com/dza7mzhl1/image/upload/v1689689532/upload_image_placeholder_grey_yyxr3u.png";
                    return;
                } else {
