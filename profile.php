...
<body>
    ...
    <main style="overflow: clip;">
        ...
        <div id="profile-upper">
            ...
            <div id="profile-d">
                ...
                ?>
                    <input type="file" name="" class="d-none" id="profile_input" accept="image/*">
                ...
                if ($page_user_data['id'] == USER_ID  ||  isset($_SESSION['admin_id'])) {
                ?>
                    <input type="file" name="" id="cover_photo_input" class="d-none" accept="image/*">
    ...
    <?php 
    if ($page_user_data['id'] == USER_ID  ||  isset($_SESSION['admin_id'])) require_once "./assets/js/nudes_analyser.php"; 
    ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // UPDATE PROFILE
            $(document).on('change', "#profile_input", async function(event) {
            ...
            // UPDATE COVER PHOTO
            $(document).on('change', "#cover_photo_input", async function(event) {
                let allowed_ext = ['png', 'jpg', 'gif', 'jpeg'];
                let th = $(this);
                let curr_ext = $(this).val().split(".").pop().toLowerCase();
                if ($.inArray(curr_ext, allowed_ext) !== false) {
